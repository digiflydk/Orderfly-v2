...
export function BrandWebsiteDesignSystemForm({
  brandId,
  initialDesignConfig,
}: BrandWebsiteDesignSystemFormProps) {
  ...
  const onSubmit = (data: any) => {
    startTransition(async () => {
      try {
        ...
        toast({
          title: 'Success',
          description: 'Design system settings saved successfully.',
        });
      } catch (error: any) {
        toast({
          variant: 'destructive',
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                    name="buttons.primaryVariant.background"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Primary BG</FormLabel>
                        <FormControl>
                          <Input type="color" {...field} />
                        </FormControl>
                      </FormItem>
                  ...
                  <FormField
                    control={form.control}
                    name="buttons.primaryVariant.text"
                    render={({ field }) => (
                      <FormItem>
                  ...
                  <FormField
                    control={form.control}
                    name="buttons.secondaryVariant.background"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Secondary BG</FormLabel>
                        <FormControl>
                          <Input type="color" {...field} />
                        </FormControl>
                      </FormItem>
                  ...
                  <FormField
                    control={form.control}
                    name="buttons.secondaryVariant.text"
                    render={({ field }) => (
                      <FormItem>
