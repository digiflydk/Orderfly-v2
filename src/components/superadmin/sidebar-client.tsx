...
const customerSubMenuItems = [
  { href: '/superadmin/customers', label: 'All Customers', icon: UserSearch, permission: 'users:view' },
  { href: '/superadmin/loyalty', label: 'Loyalty Settings', icon: Star, permission: 'settings:edit' },
];
...
export function SuperAdminSidebarClient({ brandingSettings }: SuperAdminSidebarClientProps) {
  ...
  const codeReviewItem = {
    href: '/superadmin/code-review',
    label: 'Code Review',
    icon: FileDiff,
  ...
  const handleMobileNavClick = () => setOpenMobile(false);
            ...
            {brandingSettings.platformLogoUrl ? (
              ...
              <>
                ...
                <h1 className="font-headline text-xl font-bold text-sidebar-foreground">
                  {brandingSettings.platformHeading ?? 'OrderFly'}
                </h1>
              </>
            )}
          </div>
            ...
            <SidebarMenuItem onClick={handleMobileNavClick}>
              <Button
                ...
                className={cn(
                  ...
                  pathname.startsWith(dashboardItem.href) && 'bg-sidebar-accent text-sidebar-accent-foreground'
                )}
              >
                  ...
                  <Collapsible open={menu.isOpen} onOpenChange={menu.onOpenChange}>
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          'w-full justify-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                          menu.isPath && 'bg-sidebar-accent text-sidebar-accent-foreground'
                        )}
                      >
                        ...
                        {menu.items.map((item) => (
                          <SidebarMenuSubItem key={item.label} onClick={handleMobileNavClick}>
                            <Button
                              ...
                              variant="ghost"
                              className={cn(
                                'w-full justify-start h-8 pl-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
              ...
              <Collapsible open={isWebsiteOpen} onOpenChange={setIsWebsiteOpen}>
                <CollapsibleTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                      isWebsitePath && 'bg-sidebar-accent text-sidebar-accent-foreground'
                    )}
                  >
              ...
              <Collapsible open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
                <CollapsibleTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                      isSettingsPath && 'bg-sidebar-accent text-sidebar-accent-foreground'
                    )}
                  >
              ...
              <Collapsible open={isValidationOpen} onOpenChange={setIsValidationOpen}>
                <CollapsibleTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                      isValidationPath && 'bg-sidebar-accent text-sidebar-accent-foreground'
                    )}
                  >
          ...
          {hasPermission(codeReviewItem.permission) && (
            <SidebarMenuItem onClick={handleMobileNavClick}>
              <Button
                ...
                className={cn(
                  'w-full justify-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
                  pathname.startsWith(codeReviewItem.href) && 'bg-sidebar-accent text-sidebar-accent-foreground'
                )}
              >
