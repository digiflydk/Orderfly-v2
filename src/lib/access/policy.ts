...
export const FEATURES = [
  ...
  ['opsfly.time', ['view', 'create', 'edit', 'approve']],
  ['opsfly.payroll', ['view', 'edit', 'approve']],
  ['opsfly.checklists', ['view', 'create', 'edit', 'delete']],
  ['opsfly.training', ['view', 'create', 'edit', 'approve']],
  ['opsfly.production', ['view', 'create', 'edit', 'approve']],
  ['opsfly.inventory', ['view', 'create', 'edit', 'approve']],
  ['opsfly.procurement', ['view', 'create', 'edit', 'approve']],
