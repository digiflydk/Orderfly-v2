    ...
    if (safe) {
      return (
        <div className="mx-auto max-w-3xl p-4">
          ...
          {menu.fallbackUsed ? (
            <p className="mt-4 text-sm opacity-70">Viser fallback “Menu”, fordi ingen kategorier fandtes.</p>
          ) : null}
        </div>
      );
    }
    ...
    return (
      <div className="mx-auto max-w-5xl p-4">
        <header className="mb-6">
          <h1 className="text-2xl font-bold sm:text-3xl">{probe.brand?.name ?? brandSlug}</h1>
