...
export async function GET(req:Request){
  ...
  try{
    ...
    return NextResponse.json({ok:true,brandId,counts:{categories:cats.size||0,products:prods.size||0,toppings:(tops as any).size||0,comboMenus:(combos as any).size||0,discounts:(discs as any).size||0}});
