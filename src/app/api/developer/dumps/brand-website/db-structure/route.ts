      ...
      collections: {
        'brands/{brandId}/website': {
          config: {
            type: 'document',
            description:
              'Brand website global configuration (design, SEO, social, tracking, legal)',
          },
          home: {
            type: 'document',
          ...
          'pages/{slug}': {
            type: 'document',
            description:
              'Custom pages for the brand website (about, catering, etc.)',
          },
          menuSettings: {
            type: 'document',
            description:
              'Configuration for the public menu page layout',
          },
        },
      },
    },
