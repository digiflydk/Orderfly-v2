...
import { updateAnalyticsSettings, updatePaymentGatewaySettings, updateLanguageSettings, updateBrandingSettings, type FormState } from './actions';
...
function SubmitButton({ children, pending }: { children: React.ReactNode; pending?: boolean }) {
    ...
    return <Button type="submit" disabled={isPending}>{isPending ? <Loader2 className="animate-spin" /> : children}</Button>;
}
            ...
            <form onSubmit={handleFormSubmit}>
                <Card>
                    ...
                    <CardFooter className="border-t px-6 py-4">
                        <SubmitButton>Save Language Settings</SubmitButton>
                    </CardFooter>
                </Card>
            </form>
        </FormProvider>
