'use client';
export default function SuperAdminSafeError({ error, reset }: { error:any; reset:()=>void }) {
  console.error('SuperAdmin Safe error:', error);
  return (
    <div style={{maxWidth:640,margin:'40px auto',padding:16,fontFamily:'system-ui,sans-serif'}}>
      <h1 style={{fontSize:20,fontWeight:600}}>Noget gik galt (SuperAdmin Safe)</h1>
