    ...
    <div className="relative h-96 overflow-hidden rounded-2xl group cursor-pointer shadow-md hover:shadow-xl transition-shadow">
      ...
      <div className="absolute bottom-0 left-0 p-6 w-full text-white">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            size="sm"
            className="bg-secondary hover:bg-secondary/90 text-black rounded-md px-6 py-2 text-xs uppercase font-bold tracking-wide transition-colors"
          >
            Vælg
          </Button>
        </div>
  ...
  return (
    <section className="container mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mt-12">
        <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground uppercase font-bold tracking-wide transition-colors">
