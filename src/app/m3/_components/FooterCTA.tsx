...
export function FooterCTA() {
  return (
    <section className="bg-m3-purple text-m3-white py-16 mt-8">
      <div className="container mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Button
          size="lg"
          className="mt-8 bg-m3-white hover:bg-m3-gray text-m3-dark font-bold uppercase tracking-wide transition-colors"
        >
